...
class Fso(models.Model):
    ...
    def create(self, vals_list):
        fsos = super().create(vals_list)
        for fso in fsos.filtered('helpdesk_ticket_id'):
            fso.message_post_with_view('helpdesk.ticket_creation',
                                       values={'self': fso, 'ticket': fso.helpdesk_ticket_id},
