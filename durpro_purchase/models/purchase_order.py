...
class PurchaseOrder(models.Model):
    ...
    shipping_policy_request = fields.Selection(
        [
            ("ship_complete", "Ship Complete"),
            ("ship_partial", "Ship Partial"),
            ("special", "Special, see note"),
        ],
        string="Shipping Policy",
    )
    shipping_timing_request = fields.Selection(
        [
            ("when_ready", "Ship When Ready"),
        ...
        for order in self:
            ...
            for line in order.order_line:
                ...
                if pending_section:
                    ...
                    line_vals.update(
                        {"sequence": sequence, "quantity": line.product_qty}
