odoo.define('durpro_reports.M2MFilters', function (require) {
...
var M2MFilters = Widget.extend(StandaloneFieldManagerMixin, {
     ...
     * @param {Object} fields
     */
    init: function (parent, fields, custom_trigger_up) {
        this._super.apply(this, arguments);
        StandaloneFieldManagerMixin.init.call(this);
        this.fields = fields;
        this.widgets = {};
        this.custom_trigger_up = custom_trigger_up ? custom_trigger_up : "value_changed";
    },
    /**
     * @override
     */
    ...
    _confirmChange: function () {
        ...
        this.trigger_up(self.custom_trigger_up, data);
        return result;
    },
    /**
